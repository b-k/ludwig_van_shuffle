...
add a name to groups. Here is my sets file for _Yiddishbbuk (St Lawrence String Quartert + Osvaldo Golijov composer).
...
Note that tracks 3-5 are unlabelled, because those are a set of songs that it's OK to shuffle.
...
```
2007-Oceana/08-Tenebrae_-__I_First_Movemen.mp3|tenebrae
